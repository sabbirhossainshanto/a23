              ...
              <div className="bt12511">
                {sports && Object.values(sports).length > 0
                  ? Object.keys(sports)
                      ...
                      .sort(
                        (keyA, keyB) => sports[keyA].sort - sports[keyB].sort
                      )
                      .map((key, index) => {
                        return (
                          <div
                          ...
                          >
                            ...
                            <div className="bt12517">
                              ...
                              <div className="bt12523">
                                <div> {sports?.[key]?.score?.player1}</div>
                                <div>{sports?.[key]?.score?.player2}</div>
                              </div>
                            </div>
                          </div>
                        );
